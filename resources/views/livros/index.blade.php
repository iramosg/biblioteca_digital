...
@section('titlepage')Livros @endsection

@section('content')
<!-- CONTEUDO -->
<section id="categoria">
		<!-- Capa -->
		<div class="banner" style="background-image: url('{{ asset("images/content/background-editar-perfil.jpg") }}');">
			<div class="grid-container">
				<div class="informacoes">
					<p class="h1">Livros</p>
					
					<div class="search">
						<form action="{{ route('livros.buscar') }}" method="POST" id="search-form">
							{{ csrf_field() }}
